...
ConnectApp = (function() {
  ...
  ConnectApp.prototype.run = function() {
    ...
    if (this.https) {
      this.server = (http2 || https).createServer({
        key: this.https.key || fs.readFileSync(__dirname + '/certs/server.key'),
        cert: this.https.cert || fs.readFileSync(__dirname + '/certs/server.crt'),
        ca: this.https.ca || fs.readFileSync(__dirname + '/certs/ca.crt'),
        passphrase: this.https.passphrase || 'gulp'
      }, this.app);
    } else {
